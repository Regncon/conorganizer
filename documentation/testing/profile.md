# Min Side og mine arrangementer

Denne sjekklisten dekker `/profile`, altså den innloggede oversiktssiden med egne arrangementer, inngangen til å opprette arrangement, eget festivalprogram og lenke videre til billettadministrasjon.
...
- [ ] `Gitt at brukeren har egne arrangementer, når seksjonen for Mine arrangementer vises, så skal arrangementene fremstå som brukerens egne og ha lenker som passer arrangementets status.`
- [ ] `Gitt at brukeren ikke har noen arrangementer ennå, når seksjonen for Mine arrangementer vises, så skal opprettelsesinngangen være tydelig og siden skal ikke se tom eller ødelagt ut.`
- [ ] `Gitt at brukeren har ett eller flere arrangementer, når seksjonen for Mine arrangementer vises, så skal hvert kort representere riktig arrangement og ikke blande data mellom ulike arrangementer.`
- [ ] `Gitt at et arrangement mangler tittel, system eller ingress, når kortet vises i Mine arrangementer, så skal kortet fortsatt være forståelig og ikke bryte layouten.`
...
- [ ] `Gitt at brukeren velger å legge til nytt arrangement fra Min Side, når handlingen lykkes, så skal brukeren få opprettet et nytt arrangement og sendes videre til riktig skjema for det nye arrangementet.`
- [ ] `Gitt at opprettelse av nytt arrangement feiler, når brukeren forsøker å opprette fra Min Side, så skal brukeren ikke havne i en stille feil eller på en side som later som om arrangementet ble opprettet.`
- [ ] `Gitt at brukeren har mange arrangementer, når seksjonen for Mine arrangementer vises, så skal kortene fortsatt være lesbare og navigerbare uten å skape kaotisk layout.`
...
- [ ] `Gitt at brukeren bruker tilbakeknapp mellom Min Side og underliggende arrangementsider, når brukeren kommer tilbake til Min Side, så skal siden fortsatt fremstå stabil og oppdatert.`
...
- Opprettelse av nytt arrangement fra Min Side egner seg godt for ende-til-ende-tester som verifiserer redirect til riktig skjema.

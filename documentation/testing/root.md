...
- [ ] `Gitt at det finnes publiserte arrangementer i én eller flere puljer, når brukeren åpner forsiden etter at programmet er publisert, så skal hver pulje vises med korrekt navn og tidspunkt.`
- [ ] `Gitt at det finnes publiserte arrangementer i flere puljer, når brukeren åpner forsiden etter at programmet er publisert, så skal arrangementene vises under riktig pulje og ikke lekke over i feil seksjon.`
- [ ] `Gitt at forsiden viser arrangementskort, når brukeren leser kortene, så skal tittel, ingress, arrangør, system og ikoner fremstå lesbare og høre til riktig arrangement.`
...
- [ ] `Gitt at forsiden ikke kan laste innhold eller arrangementsdata som forventet, når siden viser feiltilstand, så skal feilen være brukervennlig og ikke vise tekniske detaljer.`

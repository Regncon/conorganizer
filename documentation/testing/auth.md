...
- [ ] `Gitt at en innlogget bruker åpner innloggingssiden på nytt /auth/, når siden vises, så skal opplevelsen ikke skape tvil om brukerens faktiske innloggingsstatus.`

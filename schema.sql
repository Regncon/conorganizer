...
CREATE TABLE
    IF NOT EXISTS "age_groups" (age_group TEXT PRIMARY KEY);
...
CREATE TABLE
    _litestream_seq (id INTEGER PRIMARY KEY, seq INTEGER);

CREATE TABLE
    _litestream_lock (id INTEGER);

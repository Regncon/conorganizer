...
func TestTicketCard_WhenTicketCanBeConverted_RendersConvertAction(t *testing.T) {
	// Gitt at en check-in-billett ikke er middag og ikke er konvertert,
	// når billettkortet rendres,
	// så skal admin se handlingen for å konvertere billetten til deltaker.
...
func TestTicketCard_WhenTicketIsDinner_RendersDinnerWarningWithoutConvertAction(t *testing.T) {
	// Gitt at en check-in-billett er en middagsbillett,
	// når billettkortet rendres,
	// så skal kortet markere middag og ikke tilby vanlig deltakerkonvertering.
...
func TestTicketCard_WhenTicketIsAlreadyBillettholder_RendersConvertedWarningWithoutConvertAction(t *testing.T) {
	// Gitt at en check-in-billett allerede er konvertert til billettholder,
	// når billettkortet rendres,
	// så skal kortet markere dette og ikke tilby ny konvertering.
...
func TestIsBillettholder_WhenTicketIDExists_ReturnsTrue(t *testing.T) {
	// Gitt at en check-in-billett allerede finnes som billettholder,
	// når siden sjekker konverteringsstatus,
	// så skal billetten behandles som konvertert.

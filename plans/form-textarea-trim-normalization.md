...
- Keep existing `data-on-change={ datastar.PutSSE("/profile/api/new/%s/notes", eventId) }`.
...
- Keep existing `data-on-change={ datastar.PutSSE("/profile/api/new/%s/intro", eventId) }`.
...
- Keep existing `data-on-change={ datastar.PutSSE("/profile/api/new/%s/description", eventId) }`.
...
- `/profile/api/new/{id}/notes`
- `/profile/api/new/{id}/intro`
- `/profile/api/new/{id}/description`

...
const ChildFriendlyIcon = ({ color = 'primary', size = 'medium' }:Props) => {
  return (
    <SvgIcon
    ...
    <svg
   id="Layer_1"
   viewBox="0 0 26.856856 39.599998"
   version="1.1"
   width="26.856855"
   height="39.599998">
  <g
     id="Layer_7"
     transform="translate(-26.659989,-49.189999)">
    <path
       d="m 39.61,49.63 c 3.79,-0.12 5.22,2.65 5.42,5.54 0.12,1.8 -2.83,4.43 -4.67,4.37 -3.33,-0.11 -5.46,-2.36 -5.35,-5.64 0.09,-2.56 2.02,-4.35 4.6,-4.27 z"
       id="path225" />
    <path

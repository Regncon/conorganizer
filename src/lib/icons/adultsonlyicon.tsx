...
const AdultsOnlyIcon = ({ color = 'primary', size = 'medium' }:Props) => {
  return (
    <SvgIcon
    ...
    <svg
   id="Layer_1"
   viewBox="0 0 34.102146 39.599998"
   version="1.1"
   width="34.102146"
   height="39.599998">
<g
     id="Layer_3"
     transform="translate(-169.04578,-52.049999)">
    <path

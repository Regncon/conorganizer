...
const BigScreen = () => {
    ...
    return (
            ...
            <Card sx={{ width: '100%' }}>
                ...
                {conEvents.filter((conEvent) => conEvent.pool === pool.FirdayEvening).map(
                    (
                        conEvent 
                    ) => (
                        <Card
            ...
            <Card sx={{ width: '100%' }}>
                ...
                {conEvents.filter((conEvent) => conEvent.pool === pool.SaturdayMorning).map(
                    (
                        conEvent 
                    ) => (
                        <Card
            ...
            <Card sx={{ width: '100%' }}>
                ...
                {conEvents.filter((conEvent) => conEvent.pool === pool.SaturdayEvening).map(
                    (
                        conEvent 
                    ) => (
                        <Card
            ...
            <Card sx={{ width: '100%' }}>
                ...
                {conEvents.filter((conEvent) => conEvent.pool === pool.SundayMorning).map(
                    (
                        conEvent 
                    ) => (
                        <Card
